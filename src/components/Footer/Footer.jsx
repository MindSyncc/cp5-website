        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-3">
              <h5>Links</h5>
              <div className="d-flex justify-content-between"> {/* Usar flexbox para alinhar */}
                <ul className="list me-3"> {/* Margem à direita */}
                ...
                <ul className="list2">
                  ...
                  <li><a href="#" className="text-white">Notícias</a></li>
                  <li><a href="#" className="text-white">Dúvidas Gerais</a></li>
            ...
            <div className="col-md-5">
              <h5>Redes Sociais</h5>
              <a href="#" className="text-white me-4"><FaFacebook size={30} /></a>
              <a href="#" className="text-white me-4"><FaTwitter size={30} /></a>
              <a href="#" className="text-white me-4"><FaInstagram size={30} /></a>
              <a href="mailto:exemplo@dominio.com" className="text-white me-4"><FaEnvelope size={30} /></a>
            </div>
          </div>
