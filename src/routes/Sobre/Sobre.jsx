    ...
    <SobreStyle>
      <Container className="mt-5">
          ...
          <Col md={6}>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  Nossa missão é proporcionar uma experiência excepcional no
                  setor automotivo, com um foco em sustentabilidade e inovação.
                  Acreditamos que a mobilidade elétrica é o futuro e estamos
                  comprometidos em ajudar nossos clientes a fazer essa
                  transição.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col md={6}>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  Ser reconhecido como a principal empresa de veículos elétricos
                  do país, oferecendo produtos de alta qualidade e um
        ...
        <Row className="mt-4 align-items-center">
          ...
          <Col md={6}>
            <img src={equipeImage} alt="Nossa Equipe" className="img-fluid" />{" "}
            {/* Imagem ao lado */}
          </Col>
        </Row>
        <Row>
