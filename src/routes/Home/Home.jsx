...
const Slideshow = () => {
  return (
    <Carousel>
      ...
      <Carousel.Item>
        <img className="d-block w-100" src={Figura3} alt="Segundo slide" />
        <Carousel.Caption>
          {/* Adicione texto ou outros elementos aqui, se desejar */}
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img className="d-block w-100" src={Figura2} alt="Terceiro slide" />
        <Carousel.Caption>
          {/* Adicione texto ou outros elementos aqui, se desejar */}
        </Carousel.Caption>
      </Carousel.Item>
  ...
  return (
    <HomeStyle>
      ...
      <div className="jumbotron">
        ...
        <p className="lead">
          A VoltsDrive é a maior loja de carros elétricos do Brasil
        </p>
        <hr className="my-4" />
        <p>
          Junte-se à revolução verde e faça parte da mudança! Escolha um carro
          elétrico e contribua para um planeta mais limpo e sustentável. Venha
          explorar, aprender e escolher seu próximo veículo com a gente!
        </p>
        <a
      ...
      <section className="container">
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>Destaque no mercado global de EVs.</Card.Text>
        ...
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Se destaca como símbolo de inovação, inspirado no pilar "Power to
              Progress".
            </Card.Text>
            <Button variant="primary">Saber mais</Button>
          </Card.Body>
        ...
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>A primeira aposta 100% elétrica da Toyota.</Card.Text>
            <Button variant="primary">Saber mais</Button>
          </Card.Body>
        </Card>
        ...
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Apresenta a tecnologia avançada Cell-to- Body (CTB) para melhorar
              a segurança dos passageiros, com uma carroçaria reforçada que
              proporciona uma rigidez torsional comparável à de um
              superdesportivo.
            </Card.Text>
            <Button variant="primary">Saber mais</Button>
          </Card.Body>
        ...
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              O veículo possui uma aparência mais larga, conferindo uma presença
              visual imponente. Um SUV espaçoso e confortável com cinco lugares.
            </Card.Text>
            <Button variant="primary">Saber mais</Button>
          </Card.Body>
        </Card>
        ...
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Conta com um altíssimo padrão de segurança, para acompanhar toda a
              performance que o carro é capaz de entregar e garantir máxima
              proteção à sua família.
            </Card.Text>
            <Button variant="primary">Saber mais</Button>
          </Card.Body>
        </Card>
